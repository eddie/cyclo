...
// This is currently doing both parsing and translation.
// Should consider extracting out the parsing to generate
// instructions, and then do the machine translation from
// that. e.g "LD A,B" gets translated to A->B
